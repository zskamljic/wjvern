...
%NativeMethods = type { %NativeMethods_vtable_type*, %java_TypeInfo* }
...
label0:
  ...
  %4 = load %NativeMethods*, %NativeMethods** %local.0
  %5 = getelementptr inbounds %NativeMethods, %NativeMethods* %4, i32 0, i32 1
