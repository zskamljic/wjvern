...
%ForLoop = type { %ForLoop_vtable_type*, %java_TypeInfo* }
...
define void @"ForLoop_<init>()V"(%ForLoop* %param.0) personality ptr @__gxx_personality_v0 {
  %local.0 = alloca %ForLoop**
  store %ForLoop* %param.0, %ForLoop** %local.0
  br label %label0
label0:
  ; %this entered scope under name %local.0
  ; Line 1
  %1 = load %ForLoop*, %ForLoop** %local.0
  call void @"java/lang/Object_<init>()V"(%"java/lang/Object"* %1)
  %2 = load %ForLoop*, %ForLoop** %local.0
  %3 = getelementptr inbounds %ForLoop, %ForLoop* %2, i32 0, i32 0
  store %ForLoop_vtable_type* @ForLoop_vtable_data, %ForLoop_vtable_type** %3
  %4 = load %ForLoop*, %ForLoop** %local.0
  %5 = getelementptr inbounds %ForLoop, %ForLoop* %4, i32 0, i32 1
...
define i32 @"ForLoop_main()I"() personality ptr @__gxx_personality_v0 {
  ; Line 3
  %local.0 = alloca ptr
