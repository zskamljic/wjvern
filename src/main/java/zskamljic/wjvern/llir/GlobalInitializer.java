...
public class GlobalInitializer {
    ...
    public void generateEntryPoint(
        ...
        if (generated.containsKey(ENTRYPOINT)) return;

        var generator = new IrClassGenerator(ENTRYPOINT, false, definitionMapper, registry, true);
        generated.put(ENTRYPOINT, generator);
